...
struct ZakatHomeView: View {
    ...
    @ViewBuilder
    private var zakatSections: some View {
        Group {
            ZakatInputSection(
...
struct ZakatResultCard: View {
    ...
    var body: some View {
            ...
            HStack(spacing: 15) {
                VStack(alignment: .leading, spacing: 4) {
                    Text(L10n.Zakat.netAssets)
                        .font(UIDevice.current.userInterfaceIdiom == .pad ? .body : .caption2).bold()
                        .foregroundColor(.white.opacity(0.7))
                    Text("₺\(result.netAssets, specifier: "%.2f")")
                        .font(UIDevice.current.userInterfaceIdiom == .pad ? .title2 : .title3).bold()
                ...
                VStack(alignment: .trailing, spacing: 4) {
                    ...
                    Text("₺\(result.nisabThreshold, specifier: "%.2f")")
                        .font(UIDevice.current.userInterfaceIdiom == .pad ? .title3 : .subheadline).bold()
                        .foregroundColor(.white)
                }
            }
            ...
            if result.totalZakatAmount > 0 {
                VStack(alignment: .center, spacing: 8) {
                    Text(L10n.Zakat.totalZakat)
                        .font(UIDevice.current.userInterfaceIdiom == .pad ? .headline : .caption).bold()
                ...
                VStack(alignment: .center, spacing: 12) {
                    Image(systemName: "checkmark.shield.fill")
                        .font(.system(size: UIDevice.current.userInterfaceIdiom == .pad ? 44 : 30))
                        .foregroundColor(.white)
                    Text(L10n.Zakat.notRequired)
                        .font(UIDevice.current.userInterfaceIdiom == .pad ? .body : .footnote)
        ...
        .cornerRadius(UIDevice.current.userInterfaceIdiom == .pad ? 32 : 24)
