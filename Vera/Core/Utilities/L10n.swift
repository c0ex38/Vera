...
enum L10n {
    ...
    enum Home {
        ...
        static let greetingMorning = NSLocalizedString("home_selam_sabah", comment: "")
        static let greetingDay = NSLocalizedString("home_selam_gun", comment: "")
        static let greetingEvening = NSLocalizedString("home_selam_aksam", comment: "")
        static let greetingNight = NSLocalizedString("home_selam_gece", comment: "")
        static let greetingFriday = NSLocalizedString("home_selam_cuma", comment: "")
    }
    ...
    enum Sermon {
        static let errorUpdate = NSLocalizedString("error_sermon_update", comment: "")
    }
    
    // MARK: - Notifications
    enum Notification {
        static func title(_ prayer: String) -> String {
            let format = NSLocalizedString("notif_prayer_title", comment: "")
            return String(format: format, prayer)
        }
        static func body(_ prayer: String) -> String {
            let format = NSLocalizedString("notif_prayer_body", comment: "")
            return String(format: format, prayer)
        }
        static func reminderTitle(_ prayer: String) -> String {
            let format = NSLocalizedString("notif_reminder_title", comment: "")
            return String(format: format, prayer)
        }
        static func reminderBody(_ prayer: String, _ minutes: Int) -> String {
            let format = NSLocalizedString("notif_reminder_body", comment: "")
            return String(format: format, prayer, minutes)
        }
    }
    
    // MARK: - Splash
    enum Splash {
        static let tagline = NSLocalizedString("splash_tagline", comment: "")
    }
    
    // MARK: - Location Errors
    enum LocationError {
        static let cannotResolve = NSLocalizedString("error_location_cannot_resolve", comment: "")
        static func cannotGet(_ detail: String) -> String {
            let format = NSLocalizedString("error_location_cannot_get", comment: "")
    ...
    // MARK: - Home Errors
    enum HomeError {
        static let autoLocationDisabled = NSLocalizedString("error_home_auto_location_disabled", comment: "")
        static let turkeyOnly = NSLocalizedString("error_home_turkey_only", comment: "")
        static let districtEmpty = NSLocalizedString("error_home_district_empty", comment: "")
        static let resolvingLocation = NSLocalizedString("error_home_resolving_location", comment: "")
        
        static func manualLocationFailed(_ detail: String) -> String {
            let format = NSLocalizedString("error_home_manual_failed", comment: "")
            return String(format: format, detail)
        }
        static func cityNotFound(_ city: String) -> String {
            let format = NSLocalizedString("error_home_city_not_found", comment: "")
            return String(format: format, city)
        }
        static func apiFailed(_ detail: String) -> String {
            let format = NSLocalizedString("error_home_api_failed", comment: "")
            return String(format: format, detail)
        }
    }
    
    enum Premium {
        static let title = NSLocalizedString("premium_title", comment: "Vera Pro")
        static let subtitle = NSLocalizedString("premium_subtitle", comment: "Reklamları kaldırın ve destek olun")
        static let features = NSLocalizedString("premium_features", comment: "Pro Özellikler")
        static let adsFree = NSLocalizedString("premium_ads_free", comment: "Sıfır Reklam")
        static let adsFreeDetail = NSLocalizedString("premium_ads_free_detail", comment: "Tüm banner ve geçiş reklamları kaldırılır.")
        static let speed = NSLocalizedString("premium_speed", comment: "Hızlı Deneyim")
        static let speedDetail = NSLocalizedString("premium_speed_detail", comment: "Reklamsız, daha akıcı bir uygulama deneyimi.")
        static let support = NSLocalizedString("premium_support", comment: "Geliştirmeye Destek")
        static let supportDetail = NSLocalizedString("premium_support_detail", comment: "Uygulamanın yeni özelliklerle büyümesine katkıda bulunun.")
        static let subscribe = NSLocalizedString("premium_subscribe", comment: "Şimdi Abone Ol")
        static let restore = NSLocalizedString("premium_restore", comment: "Satın Almaları Geri Yükle")
        static let privacy = NSLocalizedString("premium_privacy", comment: "Gizlilik Politikası")
        static let active = NSLocalizedString("premium_active", comment: "Vera Pro Aktif")
        static let upgrade = NSLocalizedString("premium_upgrade", comment: "Pro'ya Geç")
        static let logs = NSLocalizedString("premium_logs", comment: "Sistem Günlüğü")
    }
}
