                ...
                Button(action: {
                    ...
                    HStack(spacing: 8) {
                        Image(systemName: "location.fill")
                            .font(.system(size: 14))
                        Text(preferences.savedLocationName.isEmpty ? L10n.Home.selectLocation : preferences.savedLocationName)
