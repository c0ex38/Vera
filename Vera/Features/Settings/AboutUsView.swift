...
struct AboutUsView: View {
    ...
    private var features: some View {
        AboutFeatureRow(icon: "clock.fill", title: "Hassas Vakitler", description: "Diyanet verileriyle tam uyumlu namaz vakitleri.")
        AboutFeatureRow(icon: "book.fill", title: "Kuran-ı Kerim", description: "Farklı mealler ve kullanıcı dostu okuma deneyimi.")
        AboutFeatureRow(icon: "location.north.fill", title: "Canlı Kıble", description: "Hassas sensörlerle en doğru kıble yönü.")
        AboutFeatureRow(icon: "banknote.fill", title: "Zekat Hesabı", description: "Güncel fetvalara uygun kolay hesaplama motoru.")
    }
}
